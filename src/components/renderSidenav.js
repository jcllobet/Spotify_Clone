export function renderSidenav(elementId) {
    ...
    <img src="/assets/images/sidebar/nav_logo.png" alt="spotify logo" class="nav-logo" />
        <ul class='list-group'>
            ...
            <li class="list-group-item list-group-item-action">
                <a href="/pages/search_page.html" class="d-flex">
            ...
            <li class="list-group-item list-group-item-action">
                <a href="/pages/artist.html" class="d-flex">
            ...
            <li>
                <div class="song-scroller">
                    <ol>
                        <!-- this here directs to the album page -->
